          ...
          <tbody>
            <tr>
              ...
              <td>
                <div class="dropdown">
                  <button
                    class="btn btn-secondary dropdown-toggle small-text"
                    type="button"
                  ...
                  >
                    <li>
                      <a
                        class="dropdown-item text-success small-text"
                    ...
                    <li>
                      <a
                        class="dropdown-item text-warning small-text"
                        data-value="not_submitted"
                        >Chưa nộp</a
                      >
                    </li>
                  </ul>
