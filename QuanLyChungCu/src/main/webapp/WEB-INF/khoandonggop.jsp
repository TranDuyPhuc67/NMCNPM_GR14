						...
						<div class="col-8">
							...
							<div class="row mb-3 align-items-center">
								...
								<div class="col-md-12 col-12 text-center">
									<p class="text-muted m-0 d-inline" style="font-size:20px">
										Ngày thu: <strong>${firstItem.NgayThu != null ? firstItem.NgayThu : "Chưa
								có ngày thu"}</strong>
									</p>
								</div>
							</div>
					...
					<tbody>
						<c:forEach var="item" items="${khoanDongGopList}">
							...
							<input type="hidden" name="action" value="updateKHOANDONGGOP">
									...
									<td><input type="number" name="quyTN"
										value="${item.QuyTN}" class="form-control" min="0"></td>
									<td><input type="number" name="quyKH"
										value="${item.QuyKH}" class="form-control" min="0"></td>
